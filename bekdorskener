...
@import url(https://fonts.googleapis.com/css?family=Iceland);
    body {
       font-family: Iceland;
       color: #CCCCCC;
       background-image:url(https://wallpapers.wallhaven.cc/wallpapers/full/wallhaven-62569.jpg);
       font-size: 11px;
       font-weight: bold;
    }
    .single{
...
cursor:wait;
    ...
    td {
       ...
       font-size:15px; font-family:Iceland; color:#ccff99;
    }
    .me  {
       font-size:15px; font-family:Iceland; color:#ccff99;
       border: 0px;
    ...
    .isi:disabled{
       ...
       font-family: Tahoma;
       color: #333333;
       background-image:url(https://i.imgur.com/E18gPLS.png);
       font-size: 10px;
       font-weight: bold;
    }
    .isi{
...
[ <a href='http://www.nubihaxor-exploiter.ga' target="_blank">Exploiter Online</a> ]
<br>
<br>
<br>
    <?php
    ...
    <br><br><hr width="300">
    <center>
<font face="Iceland" size="5"><font color="white">©Copyright 2017 by </a> <font size="5" face="Iceland" color="#A0CE4E" >AbrarKUN </a></font>Powered by All Defacer Indonesian <a href="SingleAttacker>www.nubihaxor.com/</a></font><br></p>
    <br><br>
    </body>
